...
class Bootstrap
{
    ...
    public function registerDemographicsEvents()
    {
            ...
            //             $dispatchResult =  $this->eventDispatcher->dispatch(new CardRenderEvent('immunization_reminders'), CardRenderEvent::EVENT_HANDLE);
            //             $viewArgs = [
    ...
    public function renderEligibilitySection(pRenderEvent $event)
    {
        ...
        $widgetTitle = xl("Immunization Remainder");
