...
public class TimeUtil {
	...
	/**
	 * Get the number of months between two dates. Note, this is exact number of months, when a
	 * month is considered to be a time period of the day to the same day in the next month.
	 * Example: A month is from March 18 to April 18. A month is not March 18 to April 17 and 2
	 * months are between March 18 and May 18.
	 * 
	 * @param date1 First date. Must be before date2.
	 * @param date2 Second date. Must be after date1.
