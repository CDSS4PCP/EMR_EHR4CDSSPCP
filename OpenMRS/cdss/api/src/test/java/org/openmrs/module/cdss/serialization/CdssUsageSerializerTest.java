...
public class CdssUsageSerializerTest {
	...
	public void test_valid_serialization() throws JsonProcessingException {
		...
		CdssUsage usage = new CdssUsage("HPV", "1", LocalDateTime.of(2024, 1, 1, 1, 1, 1), "HPV_Rule_1", "Recommendation1",
		        "Recommendation2", "Recommendation3", "Recommendation4", "Recommendation5", "Recommendation6", "ACTED");
	...
	public void test_serialize_all_fields_included() throws JsonProcessingException {
		...
		CdssUsage cdssUsage = new CdssUsage("vaccine", "patientId", "rule", LocalDateTime.of(2022, 1, 1, 0, 0, 0),
		        "recommendation1", "status");
	...
	public void test_throw_error_if_timestamp_is_null() throws JsonProcessingException {
		...
		try {
			...
			assertTrue(ioException.getMessage().contains(
			    "Required field \"timestamp\" was null when serializing \"CdssUsage\""));
		}
	}
	...
	public void test_throw_error_if_vaccine_is_null() throws JsonProcessingException {
		...
		try {
			...
			assertTrue(ioException.getMessage().contains(
			    "Required field \"vaccine\" was null when serializing \"CdssUsage\""));
		}
	}
	...
	public void test_throw_error_if_patientId_is_null() {
		...
		try {
			...
			assertTrue(ioException.getMessage().contains(
			    "Required field \"patientId\" was null when serializing \"CdssUsage\""));
		}
	}
	...
	public void test_throw_error_if_recommendation1_is_null() {
		...
		try {
			...
			assertTrue(ioException.getMessage().contains(
			    "Required field \"recommendation1\" was null when serializing \"CdssUsage\""));
		}
	}
	...
	public void test_throw_error_if_status_is_null() throws JsonProcessingException {
		...
		try {
			...
			assertTrue(ioException.getMessage()
			        .contains("Required field \"status\" was null when serializing \"CdssUsage\""));
		}
	}
